...
public class PrerequisitoProceso extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PrerequisitoProceso
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrerequisitoProceso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrerequisitoProceso().setVisible(true);
            }
        });
    }
