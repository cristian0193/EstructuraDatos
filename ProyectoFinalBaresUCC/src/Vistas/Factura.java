...
public class Factura extends javax.swing.JDialog {
    ...
    public Factura(java.awt.Frame parent, boolean modal, String _cuenta) {
        super(parent, modal);
        initComponents();
        cuenta = _cuenta;
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(txt_id_cuenta, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Factura dialog = new Factura(new javax.swing.JFrame(), true,cuenta);
