...
import static c1_despachos.frm_despacho.conexion;
...
public class DespachoCliente extends javax.swing.JFrame {
    ...
    public static Despachos_Filial despacho_f;
    public static Despachos_Productos despacho_p;
    public static Despachos_Conductor despacho_c;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String nombre_filia = txt_nombre_filial.getText();
        ...
        String nombre_conducto = txt_nombre_conductor.getText();
        ...
        int resultado = implementacion.insertarDespachos(id_filial, nombre_filia, id_producto, descripcion_producto, id_conductor, nombre_conducto, direccion, peso, autorizo, f_salida, h_salida, f_llegada, h_llegada, "NOW()");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String nomb = nombreFili(despacho_f, id);
        String nomb2 = nombreProdu(despacho_p, id);

        txt_nombre_filial.setText(nomb);
        txt_nombre_producto.setText(nomb2);
...
//        }
    ...
    public String nombreFili(Despachos_Filial despa, String id) {
    ...
    public String nombreProdu(Despachos_Productos despa, String id) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            despacho_productos = Despachos_ProductosHelper.narrow(ncRef2.resolve_str("Despachos_Productos"));

        } catch (InvalidName e) {
            System.out.println("Error Name: " + e);
        } catch (NotFound e) {
            System.out.println("Error Found 2: " + e);
        } catch (CannotProceed e) {
            System.out.println("Error Proceed: " + e);
        } catch (org.omg.CosNaming.NamingContextPackage.InvalidName e) {
            System.out.println("Error: " + e);
