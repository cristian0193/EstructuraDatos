...
public class EliminacionMasivaPermisoGenerales extends javax.swing.JDialog {

    DefaultTableModel modelo;
    ConexioSQLite conexion;

    public EliminacionMasivaPermisoGenerales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ELIMINACION MASIVA DE DATOS (PERMISOS GENERALES)");
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        if (this.date_fecha_inicio.getDate() == null) {
            ...
            if (JOptionPane.OK_OPTION == confirmado) {
                ...
                boolean resultado = conexion.eliminacion_masiva_permisos_general(fecha_ingresada_inicio, fecha_ingresada_final);
