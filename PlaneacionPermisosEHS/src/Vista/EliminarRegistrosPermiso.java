...
public class EliminarRegistrosPermiso extends javax.swing.JFrame {
    ...
    public EliminarRegistrosPermiso() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ELIMINACION DE REGISTROS DE VALIDACION (PERMISO INDIVIDUAL)");
        ...
        if (txt_registro_pro.getText().equals("")) {
            ...
            if (this.txt_fecha_inicio.getDate() == null || this.txt_fecha_final.getDate() == null) {
                ...
                if (JOptionPane.OK_OPTION == confirmado) {
                    ...
                    boolean resultado = conexion.delete_registro_permiso(txt_registro_pro.getText());
    ...
    private void tabla_proyectosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_proyectosMouseClicked
        ...
        this.txt_estado.setText(tabla_proyectos.getValueAt(rec, 4).toString());
