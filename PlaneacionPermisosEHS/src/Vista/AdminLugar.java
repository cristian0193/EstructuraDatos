...
public class AdminLugar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla_lugar = new javax.swing.JTable();
        ...
        tabla_lugar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabla_lugar.setRowHeight(23);
        tabla_lugar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabla_lugarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabla_lugar);
    ...
    private void tabla_lugarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_lugarMouseClicked

        int rec = this.tabla_lugar.getSelectedRow();

        this.txt_id.setText(tabla_lugar.getValueAt(rec, 0).toString());
        this.txt_nombre.setText(tabla_lugar.getValueAt(rec, 1).toString());

    }//GEN-LAST:event_tabla_lugarMouseClicked
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        ...
        if (txt_id.getText().equals("")) {
            if (txt_nombre.getText().equals("")) {
                ...
                boolean resultado = conexion.insert_lugar(nombre.toUpperCase());
            ...
            boolean resultado = conexion.upgrade_lugar(id, nombre);
    ...
    private void btn_guardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar2ActionPerformed
        ...
        if (txt_id.getText().equals("")) {
            ...
            boolean resultado = conexion.delete_lugar(id);
    ...
    private javax.swing.JTable tabla_lugar;
    ...
    public void ancho_columnas() {
        tabla_lugar.getColumnModel().getColumn(0).setPreferredWidth(50);
        tabla_lugar.getColumnModel().getColumn(1).setPreferredWidth(400);
    }
    ...
    public void centrar_datos() {
        ...
        tabla_lugar.getColumnModel().getColumn(0).setCellRenderer(Alinear);        
    }
}
