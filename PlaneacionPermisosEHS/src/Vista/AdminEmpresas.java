...
public class AdminEmpresas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla_empresas.setRowHeight(23);
    ...
    private void tabla_empresasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_empresasMouseClicked
        ...
        int rec = this.tabla_empresas.getSelectedRow();

        this.txt_id.setText(tabla_empresas.getValueAt(rec, 0).toString());
        this.txt_nombre.setText(tabla_empresas.getValueAt(rec, 1).toString());
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        ...
        if (txt_id.getText().equals("")) {
            if (txt_nombre.getText().equals("")) {
                ...
                boolean resultado = conexion.insert_empresa(nombre.toUpperCase());
            ...
            boolean resultado = conexion.upgrade_empresa(id, nombre);
    ...
    private void btn_guardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar2ActionPerformed
        ...
        if (txt_id.getText().equals("")) {
            ...
            boolean resultado = conexion.delete_empresa(id);
    ...
    public void ancho_columnas() {
        tabla_empresas.getColumnModel().getColumn(0).setPreferredWidth(50);
        tabla_empresas.getColumnModel().getColumn(1).setPreferredWidth(400);
    }

    public void centrar_datos() {
        Alinear = new DefaultTableCellRenderer();
        Alinear.setHorizontalAlignment(SwingConstants.CENTER);
        tabla_empresas.getColumnModel().getColumn(0).setCellRenderer(Alinear);
    }
