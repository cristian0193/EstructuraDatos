...
public class Poisson extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("POBABILIDAD POISSON");
        ...
        txt_Media.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_Media.setForeground(new java.awt.Color(255, 0, 0));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_Media, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(txt_Media, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Media = Double.parseDouble(txt_Media.getText());
        Q = (1 - Media);
...
//            $D$3^E3*EXP(-$D$3)/FACT(E3)
            
            arreglo_fx[i] = redondearDecimales((Math.pow(Media, i)*(Math.exp(-(Media))))/factorial(i), 4); // f(x)
        ...
        for (int m = 0; m < arreglo_N.length; m++) {
            ...
            registros_tabla[4] = "" + redondearDecimales(arreglo_R_promedio[m],0);
            registros_tabla[5] = "" + redondearDecimales(arreglo_R_promedio_2[m],0);
        ...
        txt_Promedio.setText("" + redondearDecimales(promedio,4));
