...
public class DistribucionNormal {
    ...
    /**
     * getObservaciones: Este metodo invoca al metodo que implementa el
     * algoritmo de la distribucion normal
     ...
     * @return observaciones: Se retorna el arreglo con las observaciones
     * hechas.
     */
    
    public String ResultadosObtenidos(int nObservaciones, double Media, double DStd) {
    ...
    /**
     * Normal: este metodo implementa el algoritmo de la distribucion normal del
     * libro tecnicas de simulacion del Ing. Carlos Ernesto Garcia. r contiene
     * un valor generado de manera pseudo aleatoria.
     *
