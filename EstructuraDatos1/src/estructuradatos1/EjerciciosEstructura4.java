...
public class EjerciciosEstructura4 {
    ...
    public static void main(String[] args) {
        ...
        for (int posicionTorre = 0; posicionTorre < 10; posicionTorre++) {
            for (int posicionPiso = 0; posicionPiso < 10; posicionPiso++) {
                for (int posicionSalon = 0; posicionSalon < 10; posicionSalon++) {
                    for (int posicionHora = 0; posicionHora < 10; posicionHora++) {
